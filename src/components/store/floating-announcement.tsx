...
export function FloatingAnnouncement({
  ...
  return (
    ...
    >
      <div className="bg-[#56A5F9] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.15),inset_0_-1px_0_rgba(0,0,0,0.1)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] dark:bg-sky-100 dark:text-sky-600 rounded-lg px-4 py-3 max-w-sm select-none">
